...
7. **Skills, Codex defaults** — applied where they don't conflict.
...
1. Check existing knowledge first: `docs/trading-research-2025-2026.md`, `docs/mega-prompt-polymarket-bot.md`, NotebookLM notebooks listed in `~/.Codex/rules/common/notebooklm.md`.
...
3. **Session memory** at `C:/Users/Richard/.Codex/projects/.../memory/MEMORY.md` — read on session start, written via Codex's auto-memory.
